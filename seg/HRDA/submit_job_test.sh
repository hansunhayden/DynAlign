...
runai submit  --name hrda-test3 -i registry.rcp.epfl.ch/imos-hansun/python3.8-cu11.1-torch1.9.1:v9 \
 --pvc imos-scratch:/home/hansun/nas \
 --large-shm \
 --node-pool default \
 -g 8 --command -- bash /home/hansun/nas/hansun/CODE/Diffusion_Repo/SSA/scripts/seg/HRDA/test_new.sh
