...
def parse_args():
    ...
    # with open('./hrda_args.txt', 'w') as f:
...
def main():
    ...
    # args = parser.parse_args()
    # with open('./hrda_args.txt', 'r') as f:
    ...
    if args.dataset == 'Config':
        ...
        dataset = build_dataset(
            dict(
                ...
                data_root='/home/hansun/nas/hansun/DATA/segmentation/cityscapes/',
        ...
        dataset = build_dataset(
            dict(
                ...
                data_root='/home/hansun/nas/hansun/DATA/segmentation/mapillary_vistas',
        ...
        dataset = build_dataset(
            dict(
                type='IDDDataset',
                data_root='/home/hansun/nas/hansun/DATA/segmentation/IDD_Segmentation',
                img_dir='leftImg8bit/val',
                ann_dir='gtFine/val',
                pipeline=pipeline))
    else:
    ...
    # dataset.img_infos = dataset.img_infos[0:2]
...
def seg(args):
    ...
    fold_num = math.ceil(data_num / args.data_fold)
    idx1 = (args.data_idx - 1) * fold_num
    ...
    if fp16_cfg is not None:
        wrap_fp16_model(model)
    # print("load checkpoint from local path:", args.checkpoint)
    checkpoint = load_checkpoint(
        model,
        args.checkpoint,
        map_location='cpu',
